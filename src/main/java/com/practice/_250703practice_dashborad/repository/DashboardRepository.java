package com.practice._250703practice_dashborad.repository;
...
public class DashboardRepository {
    ...
    private final RowMapper<CustomerRank> customerRankRowMapper = (resultSet, rowNum) ->
        ...
        public List<CustomerRank> findCustomerRankings() {
            String sql = """
                    SELECT customer_id, total_spent, RANK() OVER (ORDER BY total_spent DESC) AS rank FROM customer_spending
                    """;
